...
class GraphicOverlay(context: Context, attrs: AttributeSet? = null) : View(context, attrs) {
  ...
  abstract class Graphic(private val overlay: GraphicOverlay) {
     ...
     *
     * 1. [scale] adjusts the size of the supplied value from the image scale to the view scale.
     * 2. [translateX] and [translateY] adjust the coordinate from the image's coordinate system
   ...
   *     front camera.
   */
  fun setImageSourceInfo(imageWidth: Int, imageHeight: Int, isFlipped: Boolean = false) {
