---
title: Barcode Bounding Boxes in React Native
description: Draw live bounding boxes around detected QR codes and barcodes in your React Native camera scanner.
