---
title: Pro Scanner Overlay for React Native
description: A polished animated overlay with corner brackets and a scanning band for your React Native barcode scanner.
---
