---
title: Scan Region: Limit Barcode Detection Area
description: Limit React Native barcode detection to a specific area on screen with a customizable viewfinder overlay.
icon: ScanLine
---
