---
title: Introduction
description: react-native-scanner-pro is a fast, cross-platform QR code and barcode scanner for React Native apps.
icon: BookOpen
---
...
On **Android** it uses [CameraX](https://developer.android.com/training/camerax) and [Google ML Kit](https://developers.google.com/ml-kit) for detection. On **iOS** it uses [AVFoundation](https://developer.apple.com/av-foundation/) for the camera preview and [Apple Vision](https://developer.apple.com/documentation/vision) for detecting barcodes.
